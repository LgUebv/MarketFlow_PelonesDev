                    ...
                    <div class="bg-main-dark rounded-4xl p-10 shadow-2xl text-black border border-white/5" style="font-family: 'Julius Sans One', sans-serif;">
                        ...
                        <div class="space-y-8">
                            <div class="space-y-3">
                                ...
                                <div class="relative">
                                    <select wire:model="direccion_id" class="w-full bg-white/10 border border-white/20 rounded-2xl py-4 px-5 font-ligth text-sm text-black appearance-none outline-none focus:ring-2 focus:ring-btn-buy transition-all cursor-pointer">
                                        <option value="" class="text-black">Selecciona tu dirección...</option>

                                        @foreach($direcciones as $dir)
                                            <option value="{{ $dir['id'] }}" class="text-black">
                                                {{ $dir['texto'] }}
                                            </option>
                                        @endforeach
                                    </select>
